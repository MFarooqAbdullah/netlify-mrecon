...
module.exports = {
  db: {
    uri: process.env.MONGOHQ_URL || process.env.MONGODB_URI || 'mongodb://admin:admin123@recon-shard-00-00-nxg90.mongodb.net:27017,recon-shard-00-01-nxg90.mongodb.net:27017,recon-shard-00-02-nxg90.mongodb.net:27017/mrecon?replicaSet=recon-shard-0&ssl=true&authSource=admin',
    options: {},
